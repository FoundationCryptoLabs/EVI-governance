...
contract('Governor', function (accounts) {
  ...
  beforeEach(async function () {
    this.owner = owner;
    this.token = await Token.new(tokenName, tokenSymbol);//tokenName, tokenSymbol
    this.mock = await Governor.new(name, this.token.address, 4, 16, 10); //name, this.token.address, 4, 16, 10
